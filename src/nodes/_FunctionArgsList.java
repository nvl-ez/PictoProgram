    ...
    public void addArguments() {
        ...
        if (typeDimentions != null) {
            ...
            if (!st.put(description)) {
                ...
                eh.addError(ErrorPhase.Semantic, "Identifier '" + id + "' already in use", line, column);
                return;
            }
            ...
            if (type == Types.VOID) {
                ...
                eh.addError(ErrorPhase.Semantic, "Arrays cannot be of type void", line, column);
                return;
            }
            ...
            while (i != null) {
                if (!checkInt(i.getDecimal()) || i.getDecimal() <= 0) {
                    this.type = Types.NULL;
                    description.setType(Types.NULL);
                    eh.addError(ErrorPhase.Semantic, "Value " + i.getDecimal() + " is out of bounds", line, column);
                    return;
                }
                i = i.getNext();
            }
            ...
            while (i != null) {
                ...
                if (!st.putIndex(id, indexDescription)) {
                    this.type = Types.NULL;
                    description.setType(Types.NULL);
                    eh.addError(ErrorPhase.Semantic, "Identifier '" + id + "' is not an array", line, column);
                    return;
                }
                i = i.getNext();
            }
            ...
            if (type == Types.VOID) {
                this.type = Types.NULL;
                description.setType(Types.NULL);
                eh.addError(ErrorPhase.Semantic, "Arguments cannot be of type void", line, column);
                return;
            }
        }
    }
